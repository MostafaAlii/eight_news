        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- End Dashboard -->
                    <!-- StartAdmins & Teacher & Student  Menu -->
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('admins.index')}}">المديرين</a></li>
                            <li><a href="{{route('publishers.index')}}">الناشرين</a></li>
                            <li><a href="{{route('users.index')}}">المستخدمين</a></li>
                        </ul>
                    </li>
                    <!-- End Admins & Teacher & Student  Menu -->
                    <!-- menu item calendar-->
                    <li>
                        ...
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('categories.index')}}">جميع الاقسام </a> </li>
                        </ul>
                    </li>
                    <!-- Start Advertisments -->
                    <li>
                    ...
                    <!-- Start Sections -->
                    <li>
                        <a href="{{route('sections.index')}}"><i class="ti-comments"></i><span class="right-nav-text">
                                المجالات
                            </span></a>
                    </li>
                    <!-- End Sections -->
                    <!-- menu item todo-->
                    <li>
                        <a href="{{route('tag.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text">
                                الكلمات المفتاحيه
                                </span> </a>
                    </li>
                    <!-- menu item chat-->
                    <li>
                        <a href="{{route('post.index')}}"><i class="ti-comments"></i><span class="right-nav-text">
                                المنشورات
                            </span></a>
                    </li>
                    <!-- menu item mailbox-->
